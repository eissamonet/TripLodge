...
const MyBookings = () => {
  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        title="My Bookings"
        subTitle="Easily manage your past, current and upcoming reservations in one place.
        ...
        {bookings.map((booking) => (
          ...
          >
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!booking.isPaid && (
                <button onClick={() => handlePayment(booking._id)} className="px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-slate-300 transition-all cursor-pointer">
                  Pay Now
                </button>
              )}
            </div>
